...
g_savedata.userAddonConfig = {
    ...
    despawnDistance = property.slider("Asteroid Despawn Range - How far a player must go from an asteroid for it to despawn", 100.0, 500.0, 1.0, 150.0),
    spawnDistance = property.slider("Asteroid Spawn Distance - How close/far an asteroid spawns near a player", 12.0, 200.0, 1.0, 65.0),
    travelDistance = property.slider("Required Travel Distance To Spawn Asteroids - How far a player must travel for asteroids to spawn near them", 25.0, 2000.0, 10.0, 100.0)
}
